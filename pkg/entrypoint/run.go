...
const (
	...
	// DefaultShouldWaitForPrevStep is ...
	DefaultShouldWaitForPrevStep = false

	// DefaultShouldRunPostRun is ...
	DefaultShouldRunPostRun = false

	// DefaultPreRunFile is ...
	DefaultPreRunFile = "0"

	// DefaultPostRunFile is ...
...
func (o Options) ExecuteProcess() (int, error) {
	...
	case <-time.After(timeout):
		logrus.Errorf("Previous step did not finish within %s timeout", timeout)
		cancelled = true
	}
